...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
                    prog='Handwriting Synthesis',
                    description='Let us generate some handwriting together',
                    epilog='Text at the bottom of help')
    parser.add_argument('-t', '--text')
    args = parser.parse_args()
    lines = textwrap.wrap(args.text, 32, break_long_words=False)
    print(lines)

    biases = [.75 for i in lines]
    styles = [5 for i in lines]
    stroke_colors = ['#000F55' for i in lines]
